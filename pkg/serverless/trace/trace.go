...
func (s *ServerlessTraceAgent) Start(enabled bool, loadConfig Load, otelSpanChan, lambdaSpanChan chan<- *pb.Span, coldStartSpanId uint64) {
	if enabled {
