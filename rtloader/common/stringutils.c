...
size_t copy_attr_as_string_at(PyObject* object, const char* attributeName, void* buf, size_t bufOffset, size_t bufLength) {
    return copy_attr_as_string(object, attributeName,
        string_buf_from_offset(buf, bufOffset),
